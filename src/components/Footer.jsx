  ...
  return (
    ...
    <div className='bg-black p-8' >
          ...
          <div className='flex flex-col md:flex-row gap-2'>
            ...
            <NavLink to={'https://www.zomato.com/kolkata/bonntonn-gourmet-gift-studio-alipore'}>
              <div className='bg-white rounded-xl flex justify-center w-full p-2'>
                <img className='w-full md:w-[120px] h-[30px]' src='./zomato-logo.png'/>
              </div>
              </NavLink>

              <NavLink to={'https://www.swiggy.com/city/kolkata/bonn-tonn-gourmet-opposite-papillon-flower-shop-alipore-rest705986'}>
                <div className='bg-white rounded-xl flex justify-center w-full p-2'>
                  <img className='w-full md:w-[120px] h-[30px]' src='./swiggy-logo.png'/>
                </div>
              </NavLink>
            </div>

              <NavLink to={'https://bonntonn.petpooja.com'}>
                <div className='bg-white rounded-xl flex flex-col justify-center w-[240px] md:w-[180px] p-2'>
      ...
      <div className='mt-20 py-8 border-t'>
         <p className='w-full px-4 font-medium mx-auto text-center text-white b'>&copy; {currentYear} Bonntonn Gourmet Gifting Studio. All rights reserved.</p>
       </div>
      </div>
    </div>
  )
